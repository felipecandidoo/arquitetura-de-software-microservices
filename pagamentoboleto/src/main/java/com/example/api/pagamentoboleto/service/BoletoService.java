package com.example.api.pagamentoboleto.service;
...
public class BoletoService {
    ...
    public ResponseDTO boleto(TransacaoDTO transacaoDTO) throws SaldoInsuficienteException, ContaBloqueadaException {
